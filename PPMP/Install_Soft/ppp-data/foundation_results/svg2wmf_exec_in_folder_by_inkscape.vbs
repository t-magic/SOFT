...
'                WScript.Echo objFile.Name
                ...
                WScript.Echo svgName
                'Set Shell = WScript.CreateObject("WScript.Shell")
                'Shell.Run """C:\Program Files\Inkscape\inkscape.exe"" --file " & objFile.Name & " --export-wmf " & svgName, 3, True
                Set objExec = Shell.Exec("""C:\Program Files\Inkscape\inkscape.exe"" --file " & objFile.Name & " --export-wmf " & svgName)
                
                Do While objExec.Status = 0
                  WScript.Sleep 100
                Loop
                
                fcresult = svgName & VbCr & objExec.ExitCode
                WScript.Echo fcresult
